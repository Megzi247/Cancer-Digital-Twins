...
""", unsafe_allow_html=True)
    ...
    TD_LABEL = 'padding:10px 20px 10px 8px;color:#7fb3c8;font-size:1.0em;white-space:nowrap;border-bottom:1px solid #1e3a4f;vertical-align:middle'
    TD_VALUE = 'padding:10px 8px 10px 20px;font-size:1.0em;font-weight:600;border-bottom:1px solid #1e3a4f;vertical-align:middle'
